...
export default function Experience(){
    ...
    return(
        <div id="experience" className="py-10 w-full contenedor-seccion flex flex-col items-center">
