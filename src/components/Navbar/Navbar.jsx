...
export default function Navbar(){
    ...
    return(
        <header className="flex flex-col md:flex-row md:justify-between relative">
            ...
            <div className="hidden md:flex items-center">
                <ul className="text-textHero w-full flex">
                    <li className="p-2"><a className="px-4 py-2  text-textHero font-semibold" href="#aboutme">About me</a></li>
                    <li className="p-2"><a className="px-4 py-2  text-textHero font-semibold" href="#skills">Skills</a></li>
                    <li className="p-2"><a className="px-4 py-2  text-textHero font-semibold" href="#portfolio">Portfolio</a></li>
                    <li className="p-2"><a className="px-4 py-2  text-textHero font-semibold" href="#experience">Experience</a></li>
                    <li className="p-2"><a className="px-4 py-2 rounded-full  text-black bg-textHero font-semibold" href="#contactme">Contact me</a></li>
                </ul>
            </div>
            <AnimatePresence>
                {menuVisible &&
                (<motion.div 
                    ...
                    exit={{ height: '0px' }}
                className="absolute w-full" style={{top:'51px',backgroundImage:'url(pexels-photo.png)',backgroundPosition:'inherit',backgroundAttachment:'fixed'}}>
                    {menuVisible && (<motion.nav 
                        initial={{ height: '0px' }}
