export default function HeroMovil(){
    return(
        <div className="bg-black sm:hidden relative overflow-hidden z-0" style={{height:'600px',backgroundImage:'url(perfilColor.jfif)'}}>
            <div className="absolute -bottom-32 -right-20 w-full h-72 bg-greyHero   -rotate-12 opacity-60"  style={{width:'200%'}}>
                
            </div>
            <div className="absolute bottom-0 p-8 text-textHero h-40 flex w-full justify-between">
                <div className="">
